...
SUBMIT = """
{
  ...
  "geo_orbits": [
    {
      "submitter_id": "GOES17_750W"
    }
  ],
  "core_metadata_collections": [
    {
      "submitter_id": "GOES17_CMC"
    }
  ],
  "md5sum": "%s",
  "urls": "%s"
...
def process_key(key):
    ...
    urls = "s3://noaa-goes17/%s,gs://gcp-public-data-goes-17/%s,https://osdc.rcc.uchicago.edu/noaa-goes17/%s" % (key, key, key)
